...
import { FileText, Upload, Trash2, ExternalLink, FileCheck, AlertCircle, FolderOpen } from 'lucide-react';
    ...
    <div className="space-y-2 bg-slate-50 p-3.5 rounded-xl border border-slate-200">
      <div className="flex items-center justify-between">
        ...
        {documentUrl && (
          <span className="inline-flex items-center gap-1 text-[10px] font-bold text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded-full border border-emerald-300">
            ...
            {isGoogleDriveLink ? 'Google Drive Linked' : 'Document Attached'}
          </span>
        )}
      </div>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <button
          ...
          className="px-3 py-2 bg-amber-500 hover:bg-amber-600 text-slate-950 rounded-lg text-xs font-bold transition shadow-xs flex items-center justify-center gap-1.5 shrink-0"
        >
        ...
        <button
          ...
          className="px-3 py-2 bg-white hover:bg-slate-100 text-slate-700 border border-slate-300 rounded-lg text-xs font-bold transition shadow-2xs flex items-center justify-center gap-1.5 shrink-0"
        >
      ...
      <div className="pt-1">
        <div className="relative">
          <input
            ...
            placeholder={`Or paste appointment link (Google Drive / OneDrive / URL)...`}
        ...
        <p className="text-[10px] text-slate-500 mt-1">
          Upload PDF/scanned file for <b>{positionName}</b> or link directly from your Guimba West Google Drive.
        </p>
      </div>
