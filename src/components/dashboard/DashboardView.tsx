...
export const DashboardView: React.FC<DashboardViewProps> = ({ setActiveTab, onSelectEmployee }) => {
  ...
  return (
    <div id="dashboard-view" className="space-y-6 pb-12">
      ...
      {/* Top 3 Key Statistics Cards */}
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        
        {/* Card 1: Total Active Employees */}
        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition flex items-center justify-between">
          <div>
            ...
            <p className="text-[11px] text-slate-400 mt-0.5">Active teaching & non-teaching staff</p>
          </div>
        ...
        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition flex items-center justify-between">
          <div>
            <p className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Total Inactive Employees</p>
            <h3 className="text-3xl font-extrabold text-slate-700 mt-1">{totalInactiveEmployees}</h3>
            <p className="text-[11px] text-slate-400 mt-0.5">Retired, resigned, transferred out</p>
          </div>
        ...
        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm hover:shadow-md transition flex items-center justify-between">
          <div>
            ...
            <p className="text-[11px] text-slate-400 mt-0.5">Guimba West District Schools</p>
          </div>
